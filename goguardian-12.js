/*! For license information please see goguardian-12.js.LICENSE.txt */
( () => {
    var t = {
        29207: (t, n, e) => {
            var r = e(2543)
        ...
        2543: function(t, n, e) {
            ...
            t = e.nmd(t),
            function() {
                var i, o = "Expected a function", u = "__lodash_hash_undefined__", a = "__lodash_placeholder__", s = 32, c = 128, f = 1 / 0, l = 9007199254740991, h = NaN, p = 4294967295, d = [["ary", c], ["bind", 1], ["bindKey", 2], ["curry", 8], ["curryRight", 16], ["flip", 512], ["partial", s], ["partialRight", 64], ["rearg", 256]], v = "[object Arguments]", g = "[object Array]", _ = "[object Boolean]", y = "[object Date]", m = "[object Error]", w = "[object Function]", b = "[object GeneratorFunction]", k = "[object Map]", L = "[object Number]", S = "[object Object]", C = "[object Promise]", x = "[object RegExp]", W = "[object Set]", T = "[object String]", E = "[object Symbol]", j = "[object WeakMap]", A = "[object ArrayBuffer]", I = "[object DataView]", M = "[object Float32Array]", R = "[object Float64Array]", O = "[object Int8Array]", U = "[object Int16Array]", P = "[object Int32Array]", B = "[object Uint8Array]", D = "[object Uint8ClampedArray]", F = "[object Uint16Array]", z = "[object Uint32Array]", $ = /\b__p \+= '';/g, N = /\b(__p \+=) '' \+/g, q = /(__e\(.*?\)|\b__t\)) \+\n'';/g, H = /&(?:amp|lt|gt|quot|#39);/g, V = /[&<>"']/g, G = RegExp(H.source), J = RegExp(V.source), Z = /<%-([\s\S]+?)%>/g, K = /<%([\s\S]+?)%>/g, Y = /<%=([\s\S]+?)%>/g, X = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, Q = /^\w*$/, tt = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, nt = /[\\^$.*+?()[\]{}|]/g, et = RegExp(nt.source), rt = /^\s+/, it = /\s/, ot = /\{(?:\n\/\* \[wrapped with .+\] \*\/)?\n?/, ut = /\{\n\/\* \[wrapped with (.+)\] \*/, at = /,? & /, st = /[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g, ct = /[()=,{}\[\]\/\s]/, ft = /\\(\\)?/g, lt = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, ht = /\w*$/, pt = /^[-+]0x[0-9a-f]+$/i, dt = /^0b[01]+$/i, vt = /^\[object .+?Constructor\]$/, gt = /^0o[0-7]+$/i, _t = /^(?:0|[1-9]\d*)$/, yt = /[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g, mt = /($^)/, wt = /['\n\r\u2028\u2029\\]/g, bt = "\\ud800-\\udfff", kt = "\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff", Lt = "\\u2700-\\u27bf", St = "a-z\\xdf-\\xf6\\xf8-\\xff", Ct = "A-Z\\xc0-\\xd6\\xd8-\\xde", xt = "\\ufe0e\\ufe0f", Wt = "\\xac\\xb1\\xd7\\xf7\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf\\u2000-\\u206f \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000", Tt = "[" + bt + "]", Et = "[" + Wt + "]", jt = "[" + kt + "]", At = "\\d+", It = "[" + Lt + "]", Mt = "[" + St + "]", Rt = "[^" + bt + Wt + At + Lt + St + Ct + "]", Ot = "\\ud83c[\\udffb-\\udfff]", Ut = "[^" + bt + "]", Pt = "(?:\\ud83c[\\udde6-\\uddff]){2}", Bt = "[\\ud800-\\udbff][\\udc00-\\udfff]", Dt = "[" + Ct + "]", Ft = "\\u200d", zt = "(?:" + Mt + "|" + Rt + ")", $t = "(?:" + Dt + "|" + Rt + ")", Nt = "(?:['’](?:d|ll|m|re|s|t|ve))?", qt = "(?:['’](?:D|LL|M|RE|S|T|VE))?", Ht = "(?:" + jt + "|" + Ot + ")?", Vt = "[" + xt + "]?", Gt = Vt + Ht + "(?:" + Ft + "(?:" + [Ut, Pt, Bt].join("|") + ")" + Vt + Ht + ")*", Jt = "(?:" + [It, Pt, Bt].join("|") + ")" + Gt, Zt = "(?:" + [Ut + jt + "?", jt, Pt, Bt, Tt].join("|") + ")", Kt = RegExp("['’]", "g"), Yt = RegExp(jt, "g"), Xt = RegExp(Ot + "(?=" + Ot + ")|" + Zt + Gt, "g"), Qt = RegExp([Dt + "?" + Mt + "+" + Nt + "(?=" + [Et, Dt, "$"].join("|") + ")", $t + "+" + qt + "(?=" + [Et, Dt + zt, "$"].join("|") + ")", Dt + "?" + zt + "+" + Nt, Dt + "+" + qt, "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", At, Jt].join("|"), "g"), tn = RegExp("[" + Ft + bt + kt + xt + "]"), nn = /[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/, en = ["Array", "Buffer", "DataView", "Date", "Error", "Float32Array", "Float64Array", "Function", "Int8Array", "Int16Array", "Int32Array", "Map", "Math", "Object", "Promise", "RegExp", "Set", "String", "Symbol", "TypeError", "Uint8Array", "Uint8ClampedArray", "Uint16Array", "Uint32Array", "WeakMap", "_", "clearTimeout", "isFinite", "parseInt", "setTimeout"], rn = -1, on = {};
                on[M] = on[R] = on[O] = on[U] = on[P] = on[B] = on[D] = on[F] = on[z] = !0,
                on[v] = on[g] = on[A] = on[_] = on[I] = on[y] = on[m] = on[w] = on[k] = on[L] = on[S] = on[x] = on[W] = on[T] = on[j] = !1;
                var un = {};
                un[v] = un[g] = un[A] = un[I] = un[_] = un[y] = un[M] = un[R] = un[O] = un[U] = un[P] = un[k] = un[L] = un[S] = un[x] = un[W] = un[T] = un[E] = un[B] = un[D] = un[F] = un[z] = !0,
                un[m] = un[w] = un[j] = !1;
                var an = {
                    "\\": "\\",
                    "'": "'",
                ...
                var pe = Hn({
                  ...
                  , de = function t(n) {
                    var e, r = (n = null == n ? hn : de.defaults(hn.Object(), n, de.pick(hn, en))).Array, it = n.Date, bt = n.Error, kt = n.Function, Lt = n.Math, St = n.Object, Ct = n.RegExp, xt = n.String, Wt = n.TypeError, Tt = r.prototype, Et = kt.prototype, jt = St.prototype, At = n["__core-js_shared__"], It = Et.toString, Mt = jt.hasOwnProperty, Rt = 0, Ot = (e = /[^.]+$/.exec(At && At.keys && At.keys.IE_PROTO || "")) ? "Symbol(src)_1." + e : "", Ut = jt.toString, Pt = It.call(St), Bt = hn._, Dt = Ct("^" + It.call(Mt).replace(nt, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), Ft = vn ? n.Buffer : i, zt = n.Symbol, $t = n.Uint8Array, Nt = Ft ? Ft.allocUnsafe : i, qt = ue(St.getPrototypeOf, St), Ht = St.create, Vt = jt.propertyIsEnumerable, Gt = Tt.splice, Jt = zt ? zt.isConcatSpreadable : i, Zt = zt ? zt.iterator : i, Xt = zt ? zt.toStringTag : i, tn = function() {
                        try {
                            var t = so(St, "defineProperty");
                            return t({}, "", {}),
                            t
                        } catch (t) {}
                    }(), an = n.clearTimeout !== hn.clearTimeout && n.clearTimeout, fn = it && it.now !== hn.Date.now && it.now, ln = n.setTimeout !== hn.setTimeout && n.setTimeout, pn = Lt.ceil, dn = Lt.floor, gn = St.getOwnPropertySymbols, _n = Ft ? Ft.isBuffer : i, Pn = n.isFinite, Hn = Tt.join, ve = ue(St.keys, St), ge = Lt.max, _e = Lt.min, ye = it.now, me = n.parseInt, we = Lt.random, be = Tt.reverse, ke = so(n, "DataView"), Le = so(n, "Map"), Se = so(n, "Promise"), Ce = so(n, "Set"), xe = so(n, "WeakMap"), We = so(St, "create"), Te = xe && new xe, Ee = {}, je = Po(ke), Ae = Po(Le), Ie = Po(Se), Me = Po(Ce), Re = Po(xe), Oe = zt ? zt.prototype : i, Ue = Oe ? Oe.valueOf : i, Pe = Oe ? Oe.toString : i;
                    function Be(t) {
                    ...
                    function Tr(t, n, e) {
                        var r = null == (t = Co(t, n = gi(n, t))) ? t : t[Uo(Zo(n))];
                    ...
                    function Ir(t) {
                        return !(!Qu(t) || (n = t,
                        Ot && Ot in n)) && (Ku(t) ? Dt : vt).test(Po(t));
                        var n
                    }
                    function Mr(t) {
                        return "function" == typeof t ? t : null == t ? es : "object" == typeof t ? Nu(t) ? Br(t[0], t[1]) : Pr(t) : ls(t)
                    }
                    function Rr(t) {
                        if (!bo(t))
                            return ve(t);
                    ...
                    function Br(t, n) {
                        return yo(t) && ko(n) ? Lo(Uo(t), n) : function(e) {
                            var r = Ca(e, t);
                    ...
                    function si(t, n) {
                        return null == (t = Co(t, n = gi(n, t))) || delete t[Uo(Zo(n))]
                    }
                    function ci(t, n, e, r) {
                    ...
                    function ji(t, n) {
                        return function(e, r) {
                            ...
                            if (!Hu(e))
                                return t(e, r);
                            for (var i = e.length, o = n ? i : -1, u = St(e); (n ? o-- : ++o < i) && !1 !== r(u[o], o, u); )
                                ;
                            return e
                        }
                    }
                    ...
                    function Pi(t, n, e, o, u, a, s, f, l, h) {
                        var p = n & c
                          , d = 1 & n
                          , v = 2 & n
                          , g = 24 & n
                        ...
                        return function c() {
                            ...
                            g && m < h) {
                                var S = ae(w, k);
                                return qi(t, n, Pi, c.placeholder, e, w, S, f, l, h - m)
                            }
                            var C = d ? e : this
                              , x = v ? C[t] : t;
                            return m = w.length,
                    ...
                    function Gi(t) {
                        return function(n) {
                            var e = lo(n);
                            return e == k ? oe(n) : e == W ? ce(n) : function(t, n) {
                                return In(n, (function(n) {
                                    return [n, t[n]]
                                }
                                ))
                        ...
                        n && 1 != n)
                            w = 8 == n || 16 == n ? function(t, n, e) {
                                ...
                                return function u() {
                                    ...
                                    return (a -= l.length) < e ? qi(t, n, Pi, u.placeholder, i, s, l, i, i, e - a) : Sn(this && this !== hn && this instanceof u ? o : t, this, s)
                                }
                            }(t, n, p) : n != s && 33 != n || f.length ? Pi.apply(i, m) : function(t, n, e, i) {
                                var o = 1 & n
                                  , u = Ri(t);
                                return function n() {
                    ...
                    (ke && lo(new ke(new ArrayBuffer(1))) != I || Le && lo(new Le) != k || Se && lo(Se.resolve()) != C || Ce && lo(new Ce) != W || xe && lo(new xe) != j) && (lo = function(t) {
                        var n = Lr(t)
                    ...
                    function ra(t) {
                        ...
                        return "function" == typeof e && e instanceof e && It.call(e) == Pt
                    }
                    var ia = bn ? Kn(bn) : function(t) {
                        return ta(t) && Lr(t) == x
                    }
                      , oa = kn ? Kn(kn) : function(t) {
                        return ta(t) && lo(t) == W
                    }
                    ;
                    function ua(t) {
                    ...
                    var Wa = Bi((function(t, n, e) {
                        null != n && "function" != typeof n.toString && (n = Ut.call(n)),
                        t[n] = e
                    }
                    ), Qa(es))
                    ...
                    var ss = Fi(In)
                      ...
                      , fs = Fi(Un);
                    function ls(t) {
                        return yo(t) ? qn(Uo(t)) : function(t) {
                            return function(n) {
                                return br(n, t)
                            }
                        }(t)
                    ...
                    ), 1), ks = Hi("round"), Ls = Di((function(t, n) {
                        return t - n
                    }
                    ), 0);
                    ...
                    Be.toPath = function(t) {
                        return Nu(t) ? In(t, Uo) : aa(t) ? [t] : xi(Oo(_a(t)))
                    }
                    ,
                    Be.toPlainObject = ga,
                    ...
                    Be.lte = fa,
                    Be.max = function(t) {
                        return t && t.length ? pr(t, es, Sr) : i
                    }
                    ,
                    Be.maxBy = function(t, n) {
                        return t && t.length ? pr(t, oo(n, 2), Sr) : i
                    }
                    ,
                    Be.mean = function(t) {
                        return Nn(t, es)
                    ...
                    Be.size = function(t) {
                        ...
                        var n = lo(t);
                        return n == k || n == W ? t.size : Rr(t).length
                    }
                    ,
                    Be.snakeCase = Va,
                    ...
                    Be.template = function(t, n, e) {
                        ...
                        var g = Ya((function() {
                            return kt(s, d + "return " + h).apply(i, c)
                        }
                        ));
                        if (g.source = h,
                        Zu(g))
    ...
    ( () => {
        ...
        const t = t => t && "object" == typeof t && "function" == typeof t.then
          ...
          , v = {
            beforeUnload: {
                overrideBeforeUnload: r.dispatchCustomEvent
            },
            youtube: {
                onSettingsRequest: a.addCustomEventListener,
                settingsResponse: s.dispatchCustomEvent,
                onCheckVideo: c.addCustomEventListener,
                displayPendingOverlay: l.dispatchCustomEvent,
                videoMetadataToCheck: f.dispatchCustomEvent,
                onTrackVideo: h.addCustomEventListener,
                destroy: d.dispatchCustomEvent,
                onInjectionHealthy: p.addCustomEventListener
            },
            health: {
                checkHealth: o.dispatchCustomEventWithResponse
            }
        }
          , g = (r.addCustomEventListener,
        ...
        i.postMessageToTopFrameContentScript,
        i.addPostMessageListener,
        u.postMessageToParentFrameContentScript,
        u.addPostMessageListener,
        {
        ...
        class S {
            static milliseconds = (t, n) => new S(t,n);
            static seconds = (t, n) => new S(1e3 * t,n);
            static minutes = (t, n) => new S(60 * t * 1e3,n);
            constructor(t, n) {
                this.intervalMs = t,
                this.callback = n
            }
        ...
        const E = n => ({
          ...
          , U = E("bypassPassword/passwordAttempt")
          , P = E("bypassPassword/passwordResult")
        ...
        const ot = Object.fromEntries(it.map((t => [t, E(`health/check/${t}`)])))
          ...
          , wt = E("lock_screen")
          , bt = E("config")
          , kt = E("admin/youtube/settingsRequest")
          , Lt = E("admin/youtube/settingsResponse")
          , St = E("admin/youtube/getVideoMetadata")
        ...
        lt.sendToOffscreenDocument,
        {
            ...
            bypass: {
                passwordAttempt: U.sendToServiceWorker,
                onPasswordResult: P.addContentScriptListener
            },
            flaggedActivity: {
            ...
            youtube: {
                settingsRequest: kt.sendToServiceWorker,
                onSettingsResponse: Lt.addContentScriptListener,
                getVideoMetadata: St.sendToServiceWorker,
        ...
        () => (v.beforeUnload.overrideBeforeUnload(),
        "success"));
        xt.health.respondToHealthCheck(rt.BeforeUnloadOverrideIsolated),
        xt.beforeUnload.onOverrideBeforeUnload(Wt)
    }
    )()
}
)();
