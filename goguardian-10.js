/*! For license information please see goguardian-10.js.LICENSE.txt */
( () => {
    var n = {
        29207: (n, t, e) => {
            var r = e(2543)
        ...
        2543: function(n, t, e) {
            ...
            n = e.nmd(n),
            function() {
                var i, o = "Expected a function", u = "__lodash_hash_undefined__", a = "__lodash_placeholder__", c = 32, s = 128, f = 1 / 0, l = 9007199254740991, h = NaN, p = 4294967295, v = [["ary", s], ["bind", 1], ["bindKey", 2], ["curry", 8], ["curryRight", 16], ["flip", 512], ["partial", c], ["partialRight", 64], ["rearg", 256]], d = "[object Arguments]", g = "[object Array]", _ = "[object Boolean]", y = "[object Date]", m = "[object Error]", w = "[object Function]", b = "[object GeneratorFunction]", S = "[object Map]", k = "[object Number]", x = "[object Object]", L = "[object Promise]", W = "[object RegExp]", j = "[object Set]", C = "[object String]", A = "[object Symbol]", T = "[object WeakMap]", I = "[object ArrayBuffer]", R = "[object DataView]", M = "[object Float32Array]", O = "[object Float64Array]", E = "[object Int8Array]", U = "[object Int16Array]", D = "[object Int32Array]", z = "[object Uint8Array]", B = "[object Uint8ClampedArray]", F = "[object Uint16Array]", P = "[object Uint32Array]", $ = /\b__p \+= '';/g, N = /\b(__p \+=) '' \+/g, q = /(__e\(.*?\)|\b__t\)) \+\n'';/g, H = /&(?:amp|lt|gt|quot|#39);/g, V = /[&<>"']/g, G = RegExp(H.source), J = RegExp(V.source), Z = /<%-([\s\S]+?)%>/g, K = /<%([\s\S]+?)%>/g, Y = /<%=([\s\S]+?)%>/g, X = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, Q = /^\w*$/, nn = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, tn = /[\\^$.*+?()[\]{}|]/g, en = RegExp(tn.source), rn = /^\s+/, on = /\s/, un = /\{(?:\n\/\* \[wrapped with .+\] \*\/)?\n?/, an = /\{\n\/\* \[wrapped with (.+)\] \*/, cn = /,? & /, sn = /[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g, fn = /[()=,{}\[\]\/\s]/, ln = /\\(\\)?/g, hn = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, pn = /\w*$/, vn = /^[-+]0x[0-9a-f]+$/i, dn = /^0b[01]+$/i, gn = /^\[object .+?Constructor\]$/, _n = /^0o[0-7]+$/i, yn = /^(?:0|[1-9]\d*)$/, mn = /[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g, wn = /($^)/, bn = /['\n\r\u2028\u2029\\]/g, Sn = "\\ud800-\\udfff", kn = "\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff", xn = "\\u2700-\\u27bf", Ln = "a-z\\xdf-\\xf6\\xf8-\\xff", Wn = "A-Z\\xc0-\\xd6\\xd8-\\xde", jn = "\\ufe0e\\ufe0f", Cn = "\\xac\\xb1\\xd7\\xf7\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf\\u2000-\\u206f \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000", An = "[" + Sn + "]", Tn = "[" + Cn + "]", In = "[" + kn + "]", Rn = "\\d+", Mn = "[" + xn + "]", On = "[" + Ln + "]", En = "[^" + Sn + Cn + Rn + xn + Ln + Wn + "]", Un = "\\ud83c[\\udffb-\\udfff]", Dn = "[^" + Sn + "]", zn = "(?:\\ud83c[\\udde6-\\uddff]){2}", Bn = "[\\ud800-\\udbff][\\udc00-\\udfff]", Fn = "[" + Wn + "]", Pn = "\\u200d", $n = "(?:" + On + "|" + En + ")", Nn = "(?:" + Fn + "|" + En + ")", qn = "(?:['’](?:d|ll|m|re|s|t|ve))?", Hn = "(?:['’](?:D|LL|M|RE|S|T|VE))?", Vn = "(?:" + In + "|" + Un + ")?", Gn = "[" + jn + "]?", Jn = Gn + Vn + "(?:" + Pn + "(?:" + [Dn, zn, Bn].join("|") + ")" + Gn + Vn + ")*", Zn = "(?:" + [Mn, zn, Bn].join("|") + ")" + Jn, Kn = "(?:" + [Dn + In + "?", In, zn, Bn, An].join("|") + ")", Yn = RegExp("['’]", "g"), Xn = RegExp(In, "g"), Qn = RegExp(Un + "(?=" + Un + ")|" + Kn + Jn, "g"), nt = RegExp([Fn + "?" + On + "+" + qn + "(?=" + [Tn, Fn, "$"].join("|") + ")", Nn + "+" + Hn + "(?=" + [Tn, Fn + $n, "$"].join("|") + ")", Fn + "?" + $n + "+" + qn, Fn + "+" + Hn, "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", Rn, Zn].join("|"), "g"), tt = RegExp("[" + Pn + Sn + kn + jn + "]"), et = /[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/, rt = ["Array", "Buffer", "DataView", "Date", "Error", "Float32Array", "Float64Array", "Function", "Int8Array", "Int16Array", "Int32Array", "Map", "Math", "Object", "Promise", "RegExp", "Set", "String", "Symbol", "TypeError", "Uint8Array", "Uint8ClampedArray", "Uint16Array", "Uint32Array", "WeakMap", "_", "clearTimeout", "isFinite", "parseInt", "setTimeout"], it = -1, ot = {};
                ot[M] = ot[O] = ot[E] = ot[U] = ot[D] = ot[z] = ot[B] = ot[F] = ot[P] = !0,
                ot[d] = ot[g] = ot[I] = ot[_] = ot[R] = ot[y] = ot[m] = ot[w] = ot[S] = ot[k] = ot[x] = ot[W] = ot[j] = ot[C] = ot[T] = !1;
                var ut = {};
                ut[d] = ut[g] = ut[I] = ut[R] = ut[_] = ut[y] = ut[M] = ut[O] = ut[E] = ut[U] = ut[D] = ut[S] = ut[k] = ut[x] = ut[W] = ut[j] = ut[C] = ut[A] = ut[z] = ut[B] = ut[F] = ut[P] = !0,
                ut[m] = ut[w] = ut[T] = !1;
                var at = {
                    "\\": "\\",
                    "'": "'",
                ...
                var pe = Ht({
                  ...
                  , ve = function n(t) {
                    var e, r = (t = null == t ? ht : ve.defaults(ht.Object(), t, ve.pick(ht, rt))).Array, on = t.Date, Sn = t.Error, kn = t.Function, xn = t.Math, Ln = t.Object, Wn = t.RegExp, jn = t.String, Cn = t.TypeError, An = r.prototype, Tn = kn.prototype, In = Ln.prototype, Rn = t["__core-js_shared__"], Mn = Tn.toString, On = In.hasOwnProperty, En = 0, Un = (e = /[^.]+$/.exec(Rn && Rn.keys && Rn.keys.IE_PROTO || "")) ? "Symbol(src)_1." + e : "", Dn = In.toString, zn = Mn.call(Ln), Bn = ht._, Fn = Wn("^" + Mn.call(On).replace(tn, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), Pn = dt ? t.Buffer : i, $n = t.Symbol, Nn = t.Uint8Array, qn = Pn ? Pn.allocUnsafe : i, Hn = ue(Ln.getPrototypeOf, Ln), Vn = Ln.create, Gn = In.propertyIsEnumerable, Jn = An.splice, Zn = $n ? $n.isConcatSpreadable : i, Kn = $n ? $n.iterator : i, Qn = $n ? $n.toStringTag : i, tt = function() {
                        try {
                            var n = co(Ln, "defineProperty");
                            return n({}, "", {}),
                            n
                        } catch (n) {}
                    }(), at = t.clearTimeout !== ht.clearTimeout && t.clearTimeout, ft = on && on.now !== ht.Date.now && on.now, lt = t.setTimeout !== ht.setTimeout && t.setTimeout, pt = xn.ceil, vt = xn.floor, gt = Ln.getOwnPropertySymbols, _t = Pn ? Pn.isBuffer : i, Dt = t.isFinite, Ht = An.join, de = ue(Ln.keys, Ln), ge = xn.max, _e = xn.min, ye = on.now, me = t.parseInt, we = xn.random, be = An.reverse, Se = co(t, "DataView"), ke = co(t, "Map"), xe = co(t, "Promise"), Le = co(t, "Set"), We = co(t, "WeakMap"), je = co(Ln, "create"), Ce = We && new We, Ae = {}, Te = Do(Se), Ie = Do(ke), Re = Do(xe), Me = Do(Le), Oe = Do(We), Ee = $n ? $n.prototype : i, Ue = Ee ? Ee.valueOf : i, De = Ee ? Ee.toString : i;
                    function ze(n) {
                    ...
                    Pe.prototype = Be(Fe.prototype),
                    Pe.prototype.constructor = Pe,
                    $e.prototype = Be(Fe.prototype),
                    ...
                    function Rr(n) {
                        return !(!Qu(n) || (t = n,
                        Un && Un in t)) && (Ku(n) ? Fn : gn).test(Do(n));
                        var t
                    }
                    function Mr(n) {
                    ...
                    function Gi(n) {
                        return function(t) {
                            var e = lo(t);
                            return e == S ? oe(t) : e == j ? se(t) : function(n, t) {
                                return Rt(t, (function(t) {
                                    return [t, n[t]]
                                }
                                ))
                    ...
                    (Se && lo(new Se(new ArrayBuffer(1))) != R || ke && lo(new ke) != S || xe && lo(xe.resolve()) != L || Le && lo(new Le) != j || We && lo(new We) != T) && (lo = function(n) {
                        var t = kr(n)
                    ...
                    function zo(n) {
                        if (n instanceof $e)
                            return n.clone();
                        var t = new Pe(n.__wrapped__,n.__chain__);
                    ...
                    var pu = Qi((function(n) {
                        ...
                        new Pe(r,this.__chain__).thru((function(n) {
                    ...
                    var mu = Ci((function(n, t, e) {
                      ...
                      , wu = Gr((function(n, t, e) {
                        ...
                        return fr(n, (function(n) {
                            u[++i] = o ? xt(t, n, e) : Cr(n, t, e)
                        }
                        )),
                        u
                    }
                    ))
                      , bu = Ci((function(n, t, e) {
                        rr(n, e, t)
                    }
                    ));
                    function Su(n, t) {
                    ...
                    ;
                    function ua(n) {
                        return "string" == typeof n || !Nu(n) && na(n) && kr(n) == C
                    }
                    function aa(n) {
                    ...
                    ze.includes = function(n, t, e, r) {
                        ...
                        ua(n) ? e <= i && n.indexOf(t, e) > -1 : !!i && Ft(n, t, e) > -1
                    }
                    ,
                    ...
                    ze.pad = function(n, t, e) {
                        ...
                        if (!t || r >= t)
                            return n;
                        var i = (t - r) / 2;
                        return Pi(vt(i), e) + n + Pi(pt(i), e)
                    }
                    ,
                    ze.padEnd = function(n, t, e) {
                        n = _a(n);
                        var r = (t = pa(t)) ? fe(n) : 0;
                        return t && r < t ? n + Pi(t - r, e) : n
                    }
                    ,
                    ze.padStart = function(n, t, e) {
                        n = _a(n);
                        var r = (t = pa(t)) ? fe(n) : 0;
                        return t && r < t ? Pi(t - r, e) + n : n
                    }
                    ,
                    ...
                    ze.size = function(n) {
                        ...
                        var t = lo(n);
                        return t == S || t == j ? n.size : Or(n).length
                    }
                    ,
                    ze.snakeCase = Va,
    ...
    ( () => {
        ...
        const d = n => ({
          ...
          , j = d("call/consentPending")
          , C = d("call/declinedCall")
          ...
          , F = d("explicitImageFilter/beginImageAnalysis")
          , P = d("explicitImageFilter/analyzeImage")
        ...
        Y.sendToOffscreenDocument,
        {
            ...
            calls: {
                ...
                consentPending: j.sendToServiceWorker,
                declinedCall: C.sendToServiceWorker,
            ...
            explicitImageFilter: {
                onBeginImageAnalysis: F.addContentScriptListener,
                analyzeImage: P.sendToServiceWorker
            },
            youtube: {
        ...
        (async () => {
            pn.health.respondToHealthCheck(N.Redirect),
            pn.redirect.onRedirectSubFrame((n => {
